...
export class SpriteUnitMenSecurityOfficer extends SpriteUnitMen{

  constructor(container: GameContainer) {
    super(container)
    //IDLE
    this.spriteVariants.idle.frames[0].pos = {x:262,y:88,z:0}
    this.spriteVariants.idle.frames[0].size = {x:44,y:44,z:0}
    this.spriteVariants.idle.frames[0].scale = 0.5;
    //RUNING
    this.spriteVariants.running.frames[0].pos = {x:262,y:88,z:0}
    this.spriteVariants.running.frames[0].size = {x:44,y:44,z:0}
    this.spriteVariants.running.frames[0].scale = 0.5;
    //ATTACKING
    this.spriteVariants.attacking.frames[0].pos = {x:0,y:88,z:0}
