...
export class ProjectileBoltAction762Bullet extends Projectile{
  ...
  constructor() {
    ...
    this.speedStart = new Vector(3250,3250,3250);
    this.speedMin = new Vector(0,0,0);
    this.speedMax = new Vector(3250,3250,3250);
    ...
    this.timerSet = 950; //Bullets dont need to live long
    this.timerCurrent = 950;
    ...
    this.maxImpactRange = 1100; //How far can the projectile travel?
    this.damageDropByRangeFactor = 0.7; // How much does the damage drop at the reached maxImpactRange?
    this.damageOnImpact.amounts = [(new DamageSpreadFactor(1, 250))];
    this.spreadRadiusMax = 2.333;
  }
