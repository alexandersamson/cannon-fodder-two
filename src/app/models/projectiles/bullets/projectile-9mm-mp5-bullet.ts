...
export class Projectile9mmMp5Bullet extends Projectile{
  ...
  constructor() {
    ...
    this.speedStart = new Vector(1750,1750,1750);
    this.speedMin = new Vector(0,0,0);
    this.speedMax = new Vector(1750,1750,1750);
    ...
    this.timerSet = 575; //Bullets dont need to live long
    this.timerCurrent = 575;
    ...
    this.damageOnImpact.amounts = [(new DamageSpreadFactor(1, 20))];
