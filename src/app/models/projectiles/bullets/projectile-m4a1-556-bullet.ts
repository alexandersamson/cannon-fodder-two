...
export class ProjectileM4a1556Bullet extends Projectile{
  ...
  constructor() {
    ...
    this.speedStart = new Vector(2250,2250,2250);
    this.speedMin = new Vector(0,0,0);
    this.speedMax = new Vector(2250,2250,2250);
    ...
    this.timerSet = 750; //Bullets dont need to live long
    this.timerCurrent = 750;
    ...
    this.maxImpactRange = 600; //How far can the projectile travel?
    this.damageDropByRangeFactor = 0.7; // How much does the damage drop at the reached maxImpactRange?
    this.damageOnImpact.amounts = [(new DamageSpreadFactor(1, 40))];
    this.spreadRadiusMax = 6;
  }
