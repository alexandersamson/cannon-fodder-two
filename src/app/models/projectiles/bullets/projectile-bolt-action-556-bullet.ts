...
export class ProjectileBoltAction556Bullet extends Projectile{
  ...
  constructor() {
    ...
    this.speedStart = new Vector(2750,2750,2750);
    this.speedMin = new Vector(0,0,0);
    this.speedMax = new Vector(2750,2750,2750);
    ...
    this.timerSet = 900; //Bullets dont need to live long
    this.timerCurrent = 900;
    ...
    this.maxImpactRange = 800; //How far can the projectile travel?
    this.damageDropByRangeFactor = 0.7; // How much does the damage drop at the reached maxImpactRange?
    this.damageOnImpact.amounts = [(new DamageSpreadFactor(1, 125))];
    this.spreadRadiusMax = 3;
  }
